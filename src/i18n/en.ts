export const en = {
  ...
  home: {
    ...
    techStack: {
      ...
      categories: [
        { name: 'Agentic AI', items: ['LangChain', 'LangGraph', 'CrewAI', 'AutoGen', 'LangFuse', 'MCP', 'A2A'] },
        ...
        { name: 'Observability', items: ['OpenTelemetry', 'Grafana', 'Prometheus', 'Loki', 'Alertmanager'] },
        { name: 'DevOps & Automation', items: ['Docker', 'Kubernetes', 'Terraform', 'Ansible', 'N8N', 'AWS', 'GCP', 'Azure'] },
      ],
    },
    cta: {
